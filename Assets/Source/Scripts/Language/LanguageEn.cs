public class LanguageEn : ILanguageProvider
{
    public string LoadingPart1 => "Load map";
    public string LoadingPart2 => "Load player";
    public string LoadingPart3 => "Load shop";
    public string LoadingPart4 => "Load targets";
    public string ResetProgressPart1 => "You'll get";
    public string ResetProgressPart2 => "prestige coins";
