...
namespace Player
{
    public class PlayerFactory
    {
        ...
        private PlayerCompositeRoot _playerPrefab;
        ...
        public async Task<PlayerCompositeRoot> Create(
            Vector3 position,
        ...
        {
            _playerPrefab = await _assetProvider.LoadGameObject<PlayerCompositeRoot>(AssetsKeys.Player);

            PlayerCompositeRoot player = Object.Instantiate(_playerPrefab, position, Quaternion.identity);
